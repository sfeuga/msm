...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create instrument' do
    assert_difference('Instrument.count') do
      post instruments_url, params: { instrument: { description: @instrument.description, title: @instrument.title } }
    end
  ...
  test 'should update instrument' do
    patch instrument_url(@instrument), params: {
      instrument: {
        description: @instrument.description, title: @instrument.title
      }
    }
